...
func (p *OrderServiceImpl) FindOrdersByVendorId(VendorId string, page int, limit int) ([]*models.DBOrder, error) {
	if page == 0 {
		page = 1
	}
	...
	query := bson.M{"vendor_id": VendorId} // Filter by VendorId
