...
type CreateOrderRequest struct {
	...
	VenderId string  `protobuf:"bytes,3,opt,name=VenderId,proto3" json:"VenderId,omitempty"`
...
func (x *CreateOrderRequest) GetMenuId() string {
	if x != nil {
		return x.MenuId
	}
	return ""
...
func (x *CreateOrderRequest) GetVenderId() string {
	if x != nil {
		return x.VenderId
	}
	return ""
...
func (x *CreateOrderRequest) GetRequest() string {
	if x != nil {
		return x.Request
	}
	return ""
...
var file_rpc_create_order_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0xa8, 0x01, 0x0a,
	...
	0x65, 0x6e, 0x75, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x4d, 0x65, 0x6e,
	0x75, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x56, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x49, 0x64, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x56, 0x65, 0x6e, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12,
	...
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x16, 0x0a, 0x06, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52,
